...
//class to print 2nd smallest element in an array 
public class Example19
{
    public static void main(String[] args) 
    {
        ...
        System.out.println();
        //printing 2nd smallest element in an array
        System.out.println("The 2nd smallest element in an array : " +array[1]);
