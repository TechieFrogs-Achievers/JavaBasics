...
//class to print 3rd largest number in an array
public class Example16 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println();
        //printing third largest element in an array
        System.out.println("The third largest element in an array : " +array[2]);
